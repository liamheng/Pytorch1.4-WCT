...
class WCT(nn.Module):
    def __init__(self,args):
        ...
        vgg1 = torch.load(args.vgg1)
        decoder1_torch = torch.load(args.decoder1)
        vgg2 = torch.load(args.vgg2)
        decoder2_torch = torch.load(args.decoder2)
        vgg3 = torch.load(args.vgg3)
        decoder3_torch = torch.load(args.decoder3)
        vgg4 = torch.load(args.vgg4)
        decoder4_torch = torch.load(args.decoder4)
        vgg5 = torch.load(args.vgg5)
        decoder5_torch = torch.load(args.decoder5)
